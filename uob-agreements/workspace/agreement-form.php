...
<form id="agreement-form" class="d-none" novalidate>
    <section class="workspace-card mt-4 d-none" aria-labelledby="change-reason-title" data-change-reason-section>
        <div class="workspace-card-header"><div>
            <h2 id="change-reason-title" class="h5 mb-1" data-change-reason-title>Reason for this revision</h2>
            <p class="small text-secondary mb-0" data-change-reason-description>Everyone who previously reviewed this Agreement will see this explanation beside the highlighted changes.</p>
        </div></div>
        <div class="form-section">
            <label for="change_summary" class="form-label" data-change-reason-label>What changed, and why? *</label>
