...
if (!empty($_SESSION['user_email'])) {
    ...
    try {
        ...
        $userId = $notifService->getUserIdByEmail(
            $_SESSION['user_email']
        );
...
if (isset($_GET['lang'])) {
    ...
    if (in_array($lg, $supportedLang, true)) {
        $_SESSION['lang'] = $lg;
    }
}
...
// Supports one or two parameters
// ============================================================
...
.notification-bell {
    ...
    cursor: pointer;
            ...
            'initiative_form' =>
                'نموذج إدخال المبادرة',

            'fill_required_fields' =>
                'يرجى تعبئة جميع الحقول الإلزامية بدقة',
            ...
            'rankings_sdgs' =>
                'التصنيفات والتنمية المستدامة',

            'documentation_notes' =>
                'التوثيق والملاحظات',

            'basic_data_agreement' =>
                'البيانات الأساسية وربط الاتفاقية',

            'related_agreement_question' =>
                'هل هذه المبادرة متعلقة باتفاقية قائمة؟',

            'yes_related' =>
                'نعم، المبادرة مرتبطة باتفاقية قائمة',

            'no_related' =>
                'لا، المبادرة مستقلة وغير مرتبطة باتفاقية',
            ...
            'agreement_select_help' =>
                'عند اختيار الاتفاقية ستظهر بياناتها أسفل الحقل مباشرة.',
            ...
            'outside_location_label' =>
                'إذا كانت خارج الجامعة، أين؟',

            'description_objectives' =>
                'نبذة عن المبادرة وأهدافها',

            'target_group' =>
                'الفئة المستهدفة (يمكن اختيار أكثر من فئة)',

            'beneficiaries_male' =>
                'عدد المستفيدين - الذكور',

            'beneficiaries_female' =>
                'عدد المستفيدين - الإناث',

            'youth_question' =>
                'هل الفئة المستفيدة من فئة الشباب (18 إلى 35)؟',
            ...
            'sdg_question' =>
                'هل هذه المبادرة تخدم أهداف التنمية المستدامة؟',

            'select_sdg_goals' =>
                'اختر الأهداف المناسبة (اختيار متعدد)',

            'published_question' =>
                'هل نُشرت المبادرة على موقع الجامعة؟',
            ...
            'initiative_added_success' =>
                'تمت إضافة المبادرة بنجاح.',

            'go_to_initiatives' =>
                'الذهاب إلى قائمة المبادرات',

            'example_number' =>
                'مثال: 1 أو 2025001',

            'write_title' =>
                'اكتب عنوان المبادرة بشكل واضح',
            ...
            'example_location' =>
                'مثال: مقر الجهة الشريكة / محافظة / مدينة / دولة',

            'write_description' =>
                'اكتب وصف المبادرة، أهدافها، نطاقها، وطريقة التنفيذ',

            'example_outputs' =>
                'مثال: عدد الورش المنفذة، الأدلة، التقارير، الشهادات، التوصيات...',

            'select' =>
                'اختر...',

            'google_drive_link' =>
                'رابط Google Drive أو أي رابط أدلة',

            'additional_notes' =>
                'أي ملاحظات إضافية خاصة بالجهة المنفذة',

            'required_field' =>
                'يرجى تحديد هل المبادرة مرتبطة باتفاقية قائمة أم لا.',

            'agreement_required' =>
                'اختيار الاتفاقية مطلوب.',

            'title_required' =>
                'عنوان المبادرة مطلوب.',
            ...
            'date_required' =>
                'تاريخ تنفيذ المبادرة مطلوب.',

            'location_required' =>
                'يرجى تحديد موقع تنفيذ المبادرة.',

            'outside_location_required' =>
                'يرجى كتابة مكان تنفيذ المبادرة خارج الجامعة.',

            'sdg_required' =>
                'اختر هدف تنمية مستدامة واحدًا على الأقل.',

            'news_link_required' =>
                'رابط خبر المبادرة مطلوب عند اختيار نعم.',
        ],
        ...
        'en' => [
            ...
            'add_initiative_hero_desc' =>
                'Use the comprehensive form to add a new initiative and link it to agreements, target groups, and sustainable development goals.',

            'available_agreements' =>
                'Available agreements to link',

            'approved_types' =>
                'Approved initiative types',
            ...
            'basic_data_agreement' =>
                'Basic Data & Agreement Linking',

            'related_agreement_question' =>
                'Is this initiative related to an existing agreement?',

            'yes_related' =>
                'Yes, the initiative is linked to an existing agreement',

            'no_related' =>
                'No, the initiative is independent and not linked to an agreement',
            ...
            'agreement_select_help' =>
                'When you select an agreement, its data will appear below the field.',
            ...
            'executing_entity' =>
                'Executing Entity within the University',
            ...
            'brief_summary' =>
                'Brief Summary about the initiative',
            ...
            'location_question' =>
                'Where was the initiative implemented?',
            ...
            'outside_location_label' =>
                'If outside the university, where?',

            'description_objectives' =>
                'Initiative Description & Objectives',

            'target_group' =>
                'Target Group (Multiple selections allowed)',
            ...
            'youth_question' =>
                'Are the beneficiaries from the youth category (18-35)?',
            ...
            'greenmetric_support' =>
                'Does it support GreenMetric?',

            'sdg_question' =>
                'Does this initiative serve the Sustainable Development Goals?',

            'select_sdg_goals' =>
                'Select appropriate goals (Multiple selections)',

            'published_question' =>
                'Has the initiative been published on the university website?',

            'news_link' =>
                'Initiative News Link',

            'images_link' =>
                'Images / Evidence Link',

            'entity_notes' =>
                'Executing Entity Notes',
            ...
            'go_to_initiatives' =>
                'Go to initiatives list',

            'example_number' =>
                'Example: 1 or 2025001',

            'write_title' =>
                'Write the initiative title clearly',
            ...
            'example_location' =>
                'Example: Partner headquarters / Governorate / City / Country',

            'write_description' =>
                'Write the initiative description, objectives, scope, and implementation method',

            'example_outputs' =>
                'Example: Number of workshops conducted, evidence, reports, certificates, recommendations...',

            'select' =>
                'Select...',

            'google_drive_link' =>
                'Google Drive link or any evidence link',

            'additional_notes' =>
                'Any additional notes from the executing entity',

            'required_field' =>
                'Please specify whether the initiative is related to an existing agreement or not.',

            'agreement_required' =>
                'Agreement selection is required.',
            ...
            'location_required' =>
                'Please specify the initiative location.',

            'outside_location_required' =>
                'Please write the location outside the university.',

            'sdg_required' =>
                'Select at least one Sustainable Development Goal.',

            'news_link_required' =>
                'Initiative news link is required when selecting Yes.',
        ],
    ];
    ...
    if (
        isset($dict[$currentLang][$key])
    ) {
        return $dict[$currentLang][$key];
    }


    // Fallback to provided English text
    if ($english !== null) {
        return $english;
    }
...
<div class="uob-utility-bar border-bottom">
    ...
    >
        ...
        <form
            class="<?= $isRtl ? 'ms-auto' : 'me-auto' ?> uob-search"
            action="<?= $base ?>initiatives.php"
            method="get"
        >
            ...
            <input
                ...
                type="search"
                placeholder="<?= h(t('search_initiative')) ?>"
            >
...
>
    ...
    <div class="container">
        ...
        <a
            ...
            href="<?= $base ?>index.php?lang=<?= h($lang) ?>"
        >
        ...
        >
            ...
            <ul
                class="navbar-nav <?= $isRtl ? 'me-auto' : 'ms-auto' ?> mb-2 mb-lg-0 align-items-lg-center"
            >
                ...
                <li class="nav-item">
                    ...
                    <a
                        class="nav-link"
                        href="<?= $base ?>agreements.php?lang=<?= h($lang) ?>"
                    >
                ...
                <li class="nav-item">
                    ...
                    <a
                        class="nav-link"
                        href="<?= $base ?>initiatives.php?lang=<?= h($lang) ?>"
                    >
                ...
                <li class="nav-item">
                    ...
                    <a
                        class="nav-link"
                        href="<?= $base ?>partnership/partners.php?lang=<?= h($lang) ?>"
                    >
                ...
                <?php if ($isLoggedIn): ?>
                    ...
                    <li class="nav-item">
                        ...
                        <a
                            ...
                            href="<?= $base ?>notifications.php?lang=<?= h($lang) ?>"
                        >
                ...
                <?php if (
                    ...
                    >
                        ...
                        <a
                            class="nav-link dropdown-toggle admin-dropdown-btn"
                        ...
                        <ul
                            class="dropdown-menu admin-dropdown-menu"
                        >
                            ...
                            <li>
                                ...
                                <a
                                    class="dropdown-item"
                                    href="<?= $base ?>admin/add-agreement.php?lang=<?= h($lang) ?>"
                                >
                            ...
                            <li>
                                ...
                                <a
                                    class="dropdown-item"
                                    href="<?= $base ?>admin/review-initiative-requests.php?lang=<?= h($lang) ?>"
                                >

                                    <?= $isRtl
                                        ? 'طلبات موافقة المبادرات'
                                        : 'Initiative Approval Requests'
                                    ?>
                            ...
                            <li>
                                ...
                                <a
                                    class="dropdown-item"
                                    href="<?= $base ?>admin/review-initiatives.php?lang=<?= h($lang) ?>"
                                >
                            ...
                            <li>
                                ...
                                <a
                                    class="dropdown-item"
                                    href="<?= $base ?>admin/review-agreements.php?lang=<?= h($lang) ?>"
                                >
            ...
            <div class="d-flex gap-2">
                ...
                <?php if (!$isLoggedIn): ?>
                    ...
                    <a
                        href="<?= $base ?>login.php?lang=<?= h($lang) ?>"
                ...
                <?php else: ?>
                    ...
                    <a
                        href="<?= $base ?>logout.php?lang=<?= h($lang) ?>"
            ...
            >
                ...
                >
                    ...
                    <?php foreach (
                        ...
                        <li
                            class="breadcrumb-item <?= !empty($item['active']) ? 'active' : '' ?>"
                        >
